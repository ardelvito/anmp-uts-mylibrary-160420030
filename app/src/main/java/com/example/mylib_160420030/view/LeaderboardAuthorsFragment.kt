 ...
 * Use the [LeaderboardAuthorsFragment.newInstance] factory method to
...
class LeaderboardAuthorsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LeaderboardAuthorsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LeaderboardAuthorsFragment().apply {
